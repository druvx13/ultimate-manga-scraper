...
<div class="wrap gs_popuptype_holder seo_pops">
    <h2><?php echo esc_html__("NewNovel.org Novels Scraper", 'ultimate-manga-scraper');?></h2>
<div>
         ...
         <div class="hideMain">
            ...
            <div class="table-responsive">
               <table id="mainRules" class="responsive table cr_main_table">
                  ...
                  <td class="cr_comm_td"><input type="number" step="1" min="0" name="ums_vipnovel_list[max][]" placeholder="Select the max # of generated chapters" value="<?php if(isset($ums_Main_Settings['default_chapters']) && $ums_Main_Settings['default_chapters'] != '') {echo esc_html($ums_Main_Settings['default_chapters']);}else{echo '1';} ?>" class="cr_width_60"/></td>
                  ...
                  </td><td><input type="number" min="1" name="ums_vipnovel_list[max_manga][]" value="<?php if(isset($ums_Main_Settings['default_manga']) && $ums_Main_Settings['default_manga'] != '') {echo esc_html($ums_Main_Settings['default_manga']);}else{echo '1';} ?>" placeholder="Maximum number of web novels to scrape" class="cr_width_full">
                  </div>
                  </td></tr>
				  <tr><td class="cr_min_width_200">
                  <div>
                  ...
                  <input type="text" name="ums_vipnovel_list[chapter_slug][]" value="" placeholder="chapter-1" class="cr_width_full">
                    ...
                    <td>
                    <input type="checkbox" id="strip_images" name="ums_vipnovel_list[strip_images][]" checked>
                    </div>
                    </td>
                    </tr>
                    <tr>
       ...
       if (!empty($rules)) {
           ...
           foreach ($rules as $request => $bundle[]) {
               ...
               $output .= '<tr>
                           ...
                           <td class="cr_comm_td"><input type="number" step="1" min="0" placeholder="# max" name="ums_vipnovel_list[max][]"';$output .= ' value="' . esc_attr($max) . '"  class="cr_width_60" required></td>
                           <td class="cr_status"><select id="submit_status" name="ums_vipnovel_list[submit_status][]" class="cr_width_70">
       ...
       <div class="table-responsive">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input class="cr_width_full" type="number" min="1" name="ums_vipnovel_list[max_manga][]"';$output .= ' value="' . esc_attr($max_manga) . '" placeholder="Maximum number of web novels to scrape" >
           </div>
           </td></tr>
         <tr><td colspan="2"><h3>' . esc_html__("Miscellaneous Options:", 'ultimate-manga-scraper') . '</h3></td></tr><tr><td class="cr_min_width_200">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="strip_images" name="ums_vipnovel_list[strip_images][]"';
               if ($strip_images == '1') {
                   $output .= ' checked';
               }
               $output .= '>
       ...
       <div class="codemodalfzr-footer">
         ...
         <br/><br/>
               ...
               if ($generated_posts != 0) {
                   $output .= '<a href="' . get_admin_url() . 'edit.php?coderevolution_post_source=Ums_3_' . esc_html($cont) . '&post_type=wp-manga" target="_blank">' . esc_html__('View Generated Novels', 'ultimate-manga-scraper') . '</a><br/>';
               }
