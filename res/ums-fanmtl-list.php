...
<div class="wrap gs_popuptype_holder seo_pops">
    <h2><?php echo esc_html__("FanMTL / ReadWN / Wuxia Sites Novels Scraper", 'ultimate-manga-scraper');?></h2>
<div>
         ...
         <div class="hideMain">
            ...
            <div class="table-responsive">
               <table id="mainRules" class="responsive table cr_main_table">
                     ...
                     <tr>
                        ...
                        <th>
                           ...
                           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                              <div class="bws_hidden_help_text cr_min_260px">
                                 <?php
                                    echo esc_html__("Add the URL of the Web Novel (or a comma separated list of Web Novel URLs) or a keyword search. Supported domains: fanmtl.com, fannovels.com, fansmtl.com, readwn.com, novelmt.com, novelmtl.com, wuxiabee.*, wuxiafox.com, wuxiago.com, wuxiahere.com, wuxiahub.com, wuxiamtl.com, wuxiaone.com, wuxiap.com, wuxiapub.com, wuxiaspot.com, wuxiar.com, wuxiau.com, wuxiazone.com. Example: https://fanmtl.com/novel/supreme-magus-novel - you can also add a comma separated list of similar URLs. If you want to query all web novels, you can enter here a * (star symbol).", 'ultimate-manga-scraper');
                                    ?>
                              </div>
                           </div>
                        </th>
                  ...
                  <td class="cr_short_td"><input type="text" name="ums_fanmtl_list[location][]" placeholder="https://fanmtl.com/novel/..." value="" class="cr_width_full"/></td>
                  <td class="cr_comm_td"><input type="number" step="1" min="1" name="ums_fanmtl_list[schedule][]" max="8765812" class="cr_width_60" placeholder="Select the rule schedule interval" value="<?php if(isset($ums_Main_Settings['default_schedule']) && $ums_Main_Settings['default_schedule'] != '') {echo esc_html($ums_Main_Settings['default_schedule']);}else{echo '24';} ?>"/></td>
                  <td class="cr_comm_td"><input type="number" step="1" min="0" name="ums_fanmtl_list[max][]" placeholder="Select the max # of generated chapters" value="<?php if(isset($ums_Main_Settings['default_chapters']) && $ums_Main_Settings['default_chapters'] != '') {echo esc_html($ums_Main_Settings['default_chapters']);}else{echo '1';} ?>" class="cr_width_60"/></td>
