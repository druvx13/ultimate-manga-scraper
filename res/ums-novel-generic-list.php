 ...
 */
   function ums_novel_generic_panel()
   {
        $theme = wp_get_theme();
...
<div class="wrap gs_popuptype_holder seo_pops">
    <h2><?php echo esc_html__("Generic Web Novels Scraper (Any Madara Theme Website)", 'ultimate-manga-scraper');?></h2>
<div>
...
?>
      <div>
         <div class="hideMain">
            ...
            <div class="table-responsive">
               <table id="mainRules" class="responsive table cr_main_table">
                  ...
                  <tbody>
                  <?php
                     echo ums_expand_rules_novel_generic($hu);
                  ...
                  <td class="cr_short_td"><input type="text" name="ums_novel_generic_list[location][]" placeholder="https://novelsite.com/novel/..." value="" class="cr_width_full"/></td>
                  <td class="cr_comm_td"><input type="number" step="1" min="1" name="ums_novel_generic_list[schedule][]" max="8765812" class="cr_width_60" placeholder="Select the rule schedule interval" value="<?php if(isset($ums_Main_Settings['default_schedule']) && $ums_Main_Settings['default_schedule'] != '') {echo esc_html($ums_Main_Settings['default_schedule']);}else{echo '24';} ?>"/></td>
                  <td class="cr_comm_td"><input type="number" step="1" min="0" name="ums_novel_generic_list[max][]" placeholder="Select the max # of generated chapters" value="<?php if(isset($ums_Main_Settings['default_chapters']) && $ums_Main_Settings['default_chapters'] != '') {echo esc_html($ums_Main_Settings['default_chapters']);}else{echo '1';} ?>" class="cr_width_60"/></td>
                  <td class="cr_status"><select id="submit_status" name="ums_novel_generic_list[submit_status][]" class="cr_width_70">
                  ...
                  <td class="cr_author"><select id="post_author" name="ums_novel_generic_list[post_author][]" class="cr_width_auto cr_max_width_150">
                  <?php
                  ...
                  <input type="checkbox" id="reverse_chapters" name="ums_novel_generic_list[reverse_chapters][]" checked>
                  </div>
                    </td></tr>
                  ...
                  </td><td><input type="number" min="1" name="ums_novel_generic_list[max_manga][]" value="<?php if(isset($ums_Main_Settings['default_manga']) && $ums_Main_Settings['default_manga'] != '') {echo esc_html($ums_Main_Settings['default_manga']);}else{echo '1';} ?>" placeholder="Maximum number of web novels to scrape" class="cr_width_full">
                  </div>
                  </td></tr>
				  <tr><td class="cr_min_width_200">
                  <div>
                  ...
                  <select id="default_category" name="ums_novel_generic_list[default_category][]" class="cr_width_full">
                  ...
                  <select class="cr_width_full" id="auto_categories" name="ums_novel_generic_list[auto_categories][]">
                  ...
                  <select class="cr_width_full" id="auto_tags" name="ums_novel_generic_list[auto_tags][]">
                  <option value="disabled"><?php echo esc_html__("Disabled", 'ultimate-manga-scraper');?></option>
                  ...
                  <input type="text" name="ums_novel_generic_list[default_tags][]" value="" placeholder="Please insert your additional web novel tags here" class="cr_width_full">
                  </div>
                  </td></tr>
                  <tr>
                     <td>
                     ...
                     <td>
                        <div>
                           <select id="use_phantom" name="ums_novel_generic_list[use_phantom][]" class="cr_width_full">
                  ...
                  <tr>
                        ...
                        <td>
                        <div>
                            <input type="number" min="0" step="1" id="phantom_wait" name="ums_novel_generic_list[phantom_wait][]" value="" placeholder="0" class="cr_width_full">                   
                        </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <td>
                    <input type="checkbox" id="enable_comments" name="ums_novel_generic_list[enable_comments][]" checked>
                    </div>
                    </td>
                    </tr>
                    <tr>
                    ...
                    <td>
                    <input type="checkbox" id="enable_pingback" name="ums_novel_generic_list[enable_pingback][]">
                    </div>
                    </td>
                    </tr>
                    <tr>
                    ...
                    <td>
                    <input type="checkbox" id="get_date" name="ums_novel_generic_list[get_date][]">
                    </div>
                    </td>
                    </tr>
                    <tr><td>
                  ...
                  <input type="text" name="ums_novel_generic_list[chapter_warning][]" value="" placeholder="Global Chapter Warning Message" class="cr_width_full">
                  </div>
                    </td></tr>
                    <tr><td>
                  <div>
                  ...
                  <input type="text" name="ums_novel_generic_list[chapter_slug][]" value="" placeholder="chapter-1" class="cr_width_full">
                  </div>
                    </td></tr>
                    <tr>
                    <td>
                        <div>
                            <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                <div class="bws_hidden_help_text cr_min_260px">
                                <?php
                                    echo esc_html__("Do you want to always start scraping at the above defined first chapter URL?", 'ultimate-manga-scraper');
                                    ?>
                                </div>
                            </div>
                            <b><?php echo esc_html__("Always Start At The First Chapter:", 'ultimate-manga-scraper');?></b>
                    </td>
                    <td>
                    <input type="checkbox" id="always_first" name="ums_novel_generic_list[always_first][]">
                    </div>
                    </td>
                    </tr>
                    <tr>
                    ...
                    <td>
                    <input type="checkbox" id="strip_images" name="ums_novel_generic_list[strip_images][]" checked>
                    </div>
                    </td>
                    </tr>
                    <tr>
                    ...
                    <td>
                    <select class="cr_width_full" id="translate" name="ums_novel_generic_list[rule_translate][]" >
                    <?php
                        $i = 0;
                    ...
                    <td>
                    <input type="checkbox" id="no_translate_title" name="ums_novel_generic_list[no_translate_title][]">
                    </div>
                    </td>
                    </tr>
                  </table></div>
                  ...
                  <td class="cr_comm_td"><input type="checkbox" name="ums_novel_generic_list[active][]" value="1" checked />
                  <input type="hidden" name="ums_novel_generic_list[last_run][]" value="1988-01-27 00:00:00"/></td>
         ...
         <?php
            ...
            {
                $this_page = isset($_GET["ums_page"]) ? intval($_GET["ums_page"]) : 1;
            }
            else
            {
                $this_page = '1';
...
<?php
   ...
   if (isset($_POST['ums_novel_generic_list'])) {
       add_action('admin_init', 'ums_save_rules_novel_generic');
   }
   
   function ums_save_rules_novel_generic($data2)
   {
       ...
       $data2 = $_POST['ums_novel_generic_list'];
       ...
       if (isset($data2['location'][0])) {
           for ($i = 0; $i < sizeof($data2['location']); ++$i) {
               ...
               if (isset($data2['schedule'][$i]) && $data2['schedule'][$i] != '' && trim($data2['location'][$i]) != '') {
                   ...
                   $bundle[]     = trim(sanitize_text_field($data2['always_first'][$i]));
   ...
   function ums_expand_rules_novel_generic($hu)
   {
       $ums_Main_Settings = get_option('ums_Main_Settings', false);
       $categories = get_terms( 'wp-manga-genre', array( 'hide_empty' => false ) );
       ...
       if (!empty($rules)) {
           ...
           foreach ($rules as $request => $bundle[]) {
               ...
               $output .= '<tr>
                           ...
                           <td class="cr_short_td"><input type="text" step="1" name="ums_novel_generic_list[location][]" placeholder="https://novelsite.com/novel/..." value="' . esc_attr($manga_name) . '" class="cr_width_full" required/></td>
                           <td class="cr_comm_td"><input type="number" step="1" min="1" placeholder="# h" name="ums_novel_generic_list[schedule][]" max="8765812" value="' . esc_attr($schedule) . '" class="cr_width_60" required></td>
                           <td class="cr_comm_td"><input type="number" step="1" min="0" placeholder="# max" name="ums_novel_generic_list[max][]"';$output .= ' value="' . esc_attr($max) . '"  class="cr_width_60" required></td>
                           <td class="cr_status"><select id="submit_status" name="ums_novel_generic_list[submit_status][]" class="cr_width_70">
     ...
     <div class="codemodalfzr-content">
       ...
       <div class="table-responsive">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="reverse_chapters" name="ums_novel_generic_list[reverse_chapters][]"';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input class="cr_width_full" type="number" min="1" name="ums_novel_generic_list[max_manga][]"';$output .= ' value="' . esc_attr($max_manga) . '" placeholder="Maximum number of web novels to scrape" >
           </div>
           </td></tr>
         <tr><td colspan="2"><h3>' . esc_html__("Miscellaneous Options:", 'ultimate-manga-scraper') . '</h3></td></tr><tr><td class="cr_min_width_200">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select class="cr_width_full" id="default_category" name="ums_novel_generic_list[default_category][]">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input class="cr_width_full" type="text" name="ums_novel_generic_list[default_tags][]" value="' . esc_attr($default_tags) . '" placeholder="Please insert your additional web novel tags here" >
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <div>
                       <input type="number" min="0" step="1" id="phantom_wait" name="ums_novel_generic_list[phantom_wait][]" value="' . esc_attr($phantom_wait) . '" placeholder="0" class="cr_width_full">                   
           </div>
           </td></tr><tr><td>
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="enable_comments" name="ums_novel_generic_list[enable_comments][]"';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input class="cr_width_full" type="text" name="ums_novel_generic_list[chapter_warning][]" value="' . esc_attr($chapter_warning) . '" placeholder="Global Chapter Warning Message" >
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input class="cr_width_full" type="text" name="ums_novel_generic_list[chapter_slug][]" value="' . esc_attr($chapter_slug) . '" placeholder="chapter-1" >
           ...
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Do you want to always start scraping at the above defined first chapter URL?", 'ultimate-manga-scraper') . '
                           </div>
                       </div>
                       <b>' . esc_html__("Always Start At The First Chapter", 'ultimate-manga-scraper') . ':</b>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="strip_images" name="ums_novel_generic_list[strip_images][]"';
               if ($strip_images == '1') {
                   $output .= ' checked';
               }
               $output .= '>
       ...
       <div class="codemodalfzr-footer">
         ...
         <br/><br/>
                           ...
                           <td class="cr_comm_td"><input type="checkbox" name="ums_novel_generic_list[active][]" class="activateDeactivateClass" value="1"';
               if (isset($active) && $active === '1') {
                   $output .= ' checked';
               }
               $output .= '/>
                           <input type="hidden" name="ums_novel_generic_list[last_run][]" value="' . esc_attr($last_run) . '"/></td>
                           <td class="cr_comm_td"><div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
               ...
               if ($generated_posts != 0) {
                   $output .= '<a href="' . get_admin_url() . 'edit.php?coderevolution_post_source=Ums_4_' . esc_html($cont) . '&post_type=wp-manga" target="_blank">' . esc_html__('View Generated Novels', 'ultimate-manga-scraper') . '</a><br/>';
               }
               ...
               if (!empty($running)) {
                   ...
                   {
                       $f = fopen(get_temp_dir() . 'ums_4_' . $cont, 'w');
                       if($f !== false)
                       {
               ...
               $output .= '" title="status">
                           ...
                           <select id="actions" class="actions" name="actions" onchange="actionsChangedManual(' . esc_html($cont) . ', this.value, 4);" onfocus="this.selectedIndex = 0;">
