       ...
       if (!empty($rules)) {
           ...
           foreach ($rules as $request => $bundle[]) {
               ...
               $output .= '<tr>
                           ...
                           <td class="cr_comm_td"><input type="number" step="1" min="0" placeholder="# max" name="ums_novel_generic_list[max][]"';if (stristr($hu, '143.198.112.144') !== false){ $output .= ' max="3"';} $output .= ' value="' . esc_attr($max) . '"  class="cr_width_60" required></td>
                           <td class="cr_status"><select id="submit_status" name="ums_novel_generic_list[submit_status][]" class="cr_width_70">
       ...
       <div class="table-responsive">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input class="cr_width_full" type="number" min="1" name="ums_novel_generic_list[max_manga][]"';if (stristr($hu, '143.198.112.144') !== false){ $output .= ' max="1"';} $output .= ' value="' . esc_attr($max_manga) . '" placeholder="Maximum number of web novels to scrape" >
           </div>
           </td></tr>
